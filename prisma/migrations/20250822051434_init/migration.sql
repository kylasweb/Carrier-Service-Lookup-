...
-- AddForeignKey
ALTER TABLE "ServiceRoute" ADD CONSTRAINT "ServiceRoute_polId_fkey" FOREIGN KEY ("polId") REFERENCES "Port"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ServiceRoute" ADD CONSTRAINT "ServiceRoute_podId_fkey" FOREIGN KEY ("podId") REFERENCES "Port"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
